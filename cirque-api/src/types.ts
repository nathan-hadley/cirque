...
export const ProblemSubmissionSchema = z.object({
  clientSubmissionId: z
    .string({ required_error: "Client submission ID is required" })
    .min(1, "Client submission ID is required")
    .max(100, "Client submission ID must be 100 characters or less")
    .describe("Unique identifier generated by the client to ensure idempotent submissions"),
  contact: z.object({
    name: z
